i want to make my github profile to look very clean and eye catching to recuiters so change this up so its unique and about me:
# Hello, I am Sazzadul

<a href="www.linkedin.com/in/sazzaduli507316">
...
OS: Windows, Linux
Uptime: 21 years
Host: Undergraduate Mathematics Student
IDE: VSCode, PyCharm
Languages.Programming: Python, C++, SQL
Languages.Frameworks: TensorFlow, PyTorch, Keras, React
Languages.Real: English
Contact: +44 7308631346
——————
...
Hi there! 👋 I'm Sazzadul Islam, a 2nd-year BSc Mathematics student at the University of Greenwich, passionate about solving real-world problems through technology, data, and mathematics. I enjoy exploring machine learning, data analysis, and programming, with a focus on applying these skills to fields like finance, AI, and risk management.

Here on GitHub, you'll find my projects ranging from fraud detection models and real estate price predictions to K-Means clustering and chatbot evaluation tasks. I'm proficient in Python, C++, SQL, and familiar with frameworks like TensorFlow, PyTorch, and Keras.

I'm always learning, building, and sharing my journey in technology. Feel free to check out my repositories and connect with me if you'd like to collaborate! 🚀

## Objective

Aspiring data scientist and quantitative researcher with a strong foundation in mathematics, programming, and machine learning. Currently pursuing a BSc in Mathematics at the University of Greenwich, I am eager to leverage my skills in Python, C++, and data analysis to solve complex problems in finance, AI, and risk management. Passionate about continuous learning and innovation, I aim to contribute to impactful projects and collaborate with others to develop cutting-edge solutions. Looking for opportunities to enhance my expertise and make a meaningful impact in the fields of technology and finance.

## Skills 

Programming Languages: Python, C++, SQL, R, JavaScript, HTML, CSS
Frameworks & Libraries: TensorFlow, PyTorch, Keras, Data Annotation, Model Evaluation, Statistical Modeling
Data Analysis & Visualization: Pandas, NumPy, Matplotlib, Seaborn, Tableau
Web Development: React, Flask 
Tools & Platforms: Git, GitHub, AWS, Excel, MATLAB, Figma
Other Skills: Problem-Solving, Analytical Thinking, Time Management, Collaboration          
